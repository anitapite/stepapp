...
class Step(models.Model):
    ...
    monday_activities = models.CharField(max_length=64, blank=True)
    monday_date = models.DateField()
    tuesday_stepcount = models.IntegerField()
    tuesday_activities = models.CharField(max_length=64, blank=True)
    tuesday_date = models.DateField()
    wednesday_stepcount = models.IntegerField()
    wednesday_activities = models.CharField(max_length=64, blank=True)
    wednesday_date = models.DateField()
    thursday_stepcount = models.IntegerField()
    thursday_activities = models.CharField(max_length=64, blank=True)
    thursday_date = models.DateField()
    friday_stepcount = models.IntegerField()
    friday_activities = models.CharField(max_length=64, blank=True)
    friday_date = models.DateField()
    saturday_stepcount = models.IntegerField()
    saturday_activities = models.CharField(max_length=64, blank=True)
    saturday_date = models.DateField()
    sunday_stepcount = models.IntegerField()
    sunday_activities = models.CharField(max_length=64, blank=True)
